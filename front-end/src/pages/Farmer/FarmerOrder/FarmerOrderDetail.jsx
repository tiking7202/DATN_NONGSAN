...
export default function FarmerOrderDetail({ onClose, orderIdDetail }) {
        ...
        <div className="py-4">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col my-2">
              <div className="font-medium text-xl my-2">Danh sách sản phẩm:</div>
              <div className="">
                <ul>
                  {orderDetail?.items?.length > 0 ? (
                    orderDetail.items.map((item, index) => (
                      <li key={index} className="flex justify-between text-center">
            ...
            <div className="flex my-2">
              <p className="font-medium text-xl w-1/4 mr-3">Phương thức thanh toán:</p>
              <p className="text-lg w-3/4">{orderDetail?.paymentMethod}</p>
            </div>
            <div className="flex my-2">
              <p className="font-medium text-xl w-1/4 mr-3">Trạng thái thanh toán:</p>
