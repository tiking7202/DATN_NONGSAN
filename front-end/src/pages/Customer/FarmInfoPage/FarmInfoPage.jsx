      ...
      <div className="bg-fourth m-auto flex flex-wrap justify-center">
        ...
        <div className="container mx-auto p-8 my-6 bg-white rounded-lg shadow-2xl w-4/5 text-primary">
          ...
          <p className="text-lg">
            ...
            <span className="font-medium">Số điện thoại:</span> {farmData?.farmphone}
          </p>
          <p className="text-lg">
            <FontAwesomeIcon icon={faEnvelope} className="mr-3 text-xl" />
            <span className="font-medium">Email:</span> {farmData?.farmemail}
          </p>
          <p className="text-lg">
            {" "}
            <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-3 text-xl" />
            <span className="font-medium">Tỉnh/Thành phố:</span> {farmData?.farmprovince}
          </p>
          {/* Số sản phẩm */}
